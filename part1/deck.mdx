...
<Code
  title="Example - read a file with callback"
  lang="js"
  code={require("!!raw-loader!./codes/readFileCallback.js").default}
/>
...
<CodeSurferLayout>
  <Code
    title="Example - read a file with promise"
    lang="js"
    code={require("!!raw-loader!./codes/readFilePromise.js").default}
  />
</CodeSurferLayout>
